...
public class SpecialCateAdapter3 extends RecyclerView.Adapter<SpecialCateAdapter3.UserViewHolder> {
    private Context context;
    private List<SpecialMenuUpdateListBean.SubSpecialMenueBeanX.SubSpecialMenueBean> friendList;
    private OnItemClickListener listener;
    private int position = -1;

    public SpecialCateAdapter3(Context context, List<SpecialMenuUpdateListBean.SubSpecialMenueBeanX.SubSpecialMenueBean> friendList) {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        SpecialMenuUpdateListBean.SubSpecialMenueBeanX.SubSpecialMenueBean friend = getItem(position);
    ...
    public SpecialMenuUpdateListBean.SubSpecialMenueBeanX.SubSpecialMenueBean getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(SpecialMenuUpdateListBean.SubSpecialMenueBeanX.SubSpecialMenueBean user, int position);
    }
