...
public class DownloadManageListAdapter extends RecyclerView.Adapter<DownloadManageListAdapter.UserViewHolder> {
    private Context context;
    private List<DownloadManageListBean.DataBean> friendList;
    private OnItemClickListener listener;

    public DownloadManageListAdapter(Context context, List<DownloadManageListBean.DataBean> friendList) {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        DownloadManageListBean.DataBean bean = getItem(position);
        ...
        holder.tv_info.setText(String.format("创建部门：%s", bean.getDepname()));
        holder.tv_time.setText(String.format("创建时间：%s", DateUtil.formatTime(bean.getApplytime())));
    ...
    public DownloadManageListBean.DataBean getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(DownloadManageListBean.DataBean bean);
    }
