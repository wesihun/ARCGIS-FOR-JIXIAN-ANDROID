...
public class CustomBottomSheet<V extends View> extends CoordinatorLayout.Behavior<V> {
    /**
...
//            }
    ...
    /**
     * A utility function to get the {@link CustomBottomSheet} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link CustomBottomSheet}.
     * @return The {@link CustomBottomSheet} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> CustomBottomSheet<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof CustomBottomSheet)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (CustomBottomSheet<V>) behavior;
    }
}
