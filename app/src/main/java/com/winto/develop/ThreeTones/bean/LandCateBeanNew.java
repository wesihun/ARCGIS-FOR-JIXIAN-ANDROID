...
public class LandCateBeanNew extends BaseResponse {
    ...
    private List<LandCateBeanNew> subMenue;
    ...
    public List<LandCateBeanNew> getSubMenue() {
        return subMenue;
    }

    public void setSubMenue(List<LandCateBeanNew> subMenue) {
