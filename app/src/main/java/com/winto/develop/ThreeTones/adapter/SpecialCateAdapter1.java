...
public class SpecialCateAdapter1 extends RecyclerView.Adapter<SpecialCateAdapter1.UserViewHolder> {
    private Context context;
    private List<SpecialMenuUpdateListBean> friendList;
    private OnItemClickListener listener;
    private int position;

    public SpecialCateAdapter1(Context context, List<SpecialMenuUpdateListBean> friendList) {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        SpecialMenuUpdateListBean friend = getItem(position);
    ...
    public SpecialMenuUpdateListBean getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(SpecialMenuUpdateListBean user, int position);
    }
