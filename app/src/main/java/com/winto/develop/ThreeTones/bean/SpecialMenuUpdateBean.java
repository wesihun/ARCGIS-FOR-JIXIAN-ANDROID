...
public class SpecialMenuUpdateBean extends BaseResponse {
    ...
    private List<SpecialMenuUpdateBean> subSpecialMenue;
    ...
    public List<SpecialMenuUpdateBean> getSubSpecialMenue() {
        return subSpecialMenue;
    }

    public void setSubSpecialMenue(List<SpecialMenuUpdateBean> subSpecialMenue) {
        this.subSpecialMenue = subSpecialMenue;
    }

    /*public static class SubSpecialMenueBeanX {
        *//**
         * id : 2
         * parentid : 1
         * menuename : 拆除未尽区
        ...
        public static class SubSpecialMenueBean {
            *//**
             * id : 10
             * parentid : 2
             * menuename : 测量控制点更新
