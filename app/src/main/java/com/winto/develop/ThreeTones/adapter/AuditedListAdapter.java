...
public class AuditedListAdapter extends RecyclerView.Adapter<AuditedListAdapter.AuditedViewHolder> {
    private Context context;
    private List<String> auditedList;

    public AuditedListAdapter(Context context, List<String> auditedList) {
    ...
    public AuditedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AuditedViewHolder(LayoutInflater.from(context).inflate(R.layout.item_audited_list, parent, false));
    }
