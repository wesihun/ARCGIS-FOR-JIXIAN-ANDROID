...
public class VillageListAdapter extends RecyclerView.Adapter<VillageListAdapter.UserViewHolder> {
    private Context context;
    private List<TownListBean.SubAdministrationsBean> townList;
    private OnItemClickListener listener;
    private int position = -1;

    public VillageListAdapter(Context context, List<TownListBean.SubAdministrationsBean> townList) {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        TownListBean.SubAdministrationsBean town = getItem(position);
    ...
    public TownListBean.SubAdministrationsBean getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(TownListBean.SubAdministrationsBean village, int position);
    }
